...
# Read the image for static pose estimation
try:
    img = cvv.imread(r"C:\Users\Admin\OneDrive\Desktop\build\pose-best-case-image-png-format.png")
except cvv.error as e:
...
while True:
    ...
    # Perform pose estimation on the static image
    static_image, static_points = human_pose_estimation(img.copy())
    
    # Resize static image to 50% of the screen
    static_image = cvv.resize(static_image, (int(static_image.shape[1] * 1), int(static_image.shape[0] * 1)))
